...
async def login_for_access_token(
    ...
    """
    logging.info(f"Login request for {form_data.username}")
...
async def register(request: Request):
    ...
    """
    logging.info("Register page requested")
...
async def register_user(
    ...
    """
    Handles register user form submission
    """
    validation1 = (
    ...
    logging.info(f"Registered new user with username {username}")
